...
\begin{DoxyVerb}Function to change state for finite state machine in go to poin function
...
\begin{DoxyVerb}Callback function of subscriber for topic /odom, get the position 
...
\begin{DoxyVerb}Function to rotate the robot, when he is in the right position, to 
...
\begin{DoxyVerb}Function to rotate the robot to be headed for the goal
...
\begin{DoxyVerb}Function to go straight ahead
...
\begin{DoxyVerb}Main function with declaration of a publisher for /cmd_vel topic, a 
...
\end{DoxyVerb}
 \mbox{\Hypertarget{namespacego__to__point_ae5adf65cf67db55213cd0ddb439a34f7}\label{namespacego__to__point_ae5adf65cf67db55213cd0ddb439a34f7}} 
...
\begin{DoxyVerb}Function set constants to assign velocities
