...
\item 
class \mbox{\hyperlink{classgo__to__point_1_1_position_action}{Position\+Action}}
\begin{DoxyCompactList}\small\item\em This class implement a Ros Action Server to let robot reach a goal position. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
\begin{DoxyCompactList}\small\item\em Function to change robot state. \end{DoxyCompactList}\item 
def \mbox{\hyperlink{namespacego__to__point_ac688bb56fa84763ea2edefc30cae032a}{normalize\+\_\+angle}} (angle)
\begin{DoxyCompactList}\small\item\em Function normalize an angle. \end{DoxyCompactList}\item 
def \mbox{\hyperlink{namespacego__to__point_a9c3011a3065fcbefcc1c5ad8c9979669}{fix\+\_\+yaw}} (des\+\_\+pos)
\begin{DoxyCompactList}\small\item\em Function to rotate the robot to be headed for the goal. \end{DoxyCompactList}\item 
def \mbox{\hyperlink{namespacego__to__point_ac8579665c0fbf665f734476554fac37d}{go\+\_\+straight\+\_\+ahead}} (des\+\_\+pos)
\begin{DoxyCompactList}\small\item\em Function to go straight ahead to the goal. \end{DoxyCompactList}\item 
def \mbox{\hyperlink{namespacego__to__point_a4a406386ca62830c19c93949e923f7bd}{fix\+\_\+final\+\_\+yaw}} (des\+\_\+yaw)
\begin{DoxyCompactList}\small\item\em Function to match goal orientation. \end{DoxyCompactList}\item 
def \mbox{\hyperlink{namespacego__to__point_ac2587220a4ac9c845bc9c5b0b45d5835}{done}} ()
\begin{DoxyCompactList}\small\item\em Function to stop the robot ~\newline
 \end{DoxyCompactList}\item 
def \mbox{\hyperlink{namespacego__to__point_ae5adf65cf67db55213cd0ddb439a34f7}{set\+\_\+velocities}} (msg)
\begin{DoxyCompactList}\small\item\em Function set constants to assign velocities. \end{DoxyCompactList}\item 
def \mbox{\hyperlink{namespacego__to__point_ab92bd6db1ec323a4d795ed6cb40aebe1}{main}} ()
\begin{DoxyCompactList}\small\item\em Main function with declaration of a publisher for /cmd\+\_\+vel topic, a subscriber for /odom topic, an action server for go to point service. \end{DoxyCompactList}\end{DoxyCompactItemize}
\doxysubsection*{Variables}
\begin{DoxyCompactItemize}
\item 
\mbox{\hyperlink{namespacego__to__point_a91dbaab25e6080f6b5dbf82cac6ce75c}{position\+\_\+}} = Point()
\begin{DoxyCompactList}\small\item\em goal pisition \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em velocity publisher \end{DoxyCompactList}\item 
int \mbox{\hyperlink{namespacego__to__point_a67f95834f0959feb3facd17bc7fa2b38}{yaw\+\_\+precision\+\_\+}} = math.\+pi / 9
\begin{DoxyCompactList}\small\item\em yaw precision 20 degrees \end{DoxyCompactList}\item 
int \mbox{\hyperlink{namespacego__to__point_af74ccf49164d0478ca8343e2031d5813}{yaw\+\_\+precision\+\_\+2\+\_\+}} = math.\+pi / 90
\begin{DoxyCompactList}\small\item\em yaw porecision 2 degrees \end{DoxyCompactList}\item 
float \mbox{\hyperlink{namespacego__to__point_a6a1e4eb20ebd4fce0fc56b0ebfd7a8d5}{dist\+\_\+precision\+\_\+}} = 0.\+1
\begin{DoxyCompactList}\small\item\em distannce orecision \end{DoxyCompactList}\item 
float \mbox{\hyperlink{namespacego__to__point_a524106fc7667a0927951dfd89d52d6a7}{kp\+\_\+a}} = -\/3.\+0
\begin{DoxyCompactList}\small\item\em angular velocity constant \end{DoxyCompactList}\item 
float \mbox{\hyperlink{namespacego__to__point_a7bc498652ca66932e704e738b50c297b}{kp\+\_\+d}} = 0.\+2
\begin{DoxyCompactList}\small\item\em linear velocity constant \end{DoxyCompactList}\item 
float \mbox{\hyperlink{namespacego__to__point_acb4e14986fafe5cb73bb8ad0c178869d}{ub\+\_\+a}} = 0.\+6
\begin{DoxyCompactList}\small\item\em angular velocity upper bound \end{DoxyCompactList}\item 
float \mbox{\hyperlink{namespacego__to__point_afecad4058844db05d8321199e25b4498}{lb\+\_\+a}} = -\/0.\+5
\begin{DoxyCompactList}\small\item\em angular velocity lower bound \end{DoxyCompactList}\item 
float \mbox{\hyperlink{namespacego__to__point_a16c473b9e717200c483d18e66b48152a}{ub\+\_\+d}} = 0.\+6
\begin{DoxyCompactList}\small\item\em linear velocity upper bound \end{DoxyCompactList}\end{DoxyCompactItemize}
...
{\em state} & of the finite state machine in go to point function\\
\hline
\end{DoxyParams}
Function to change state for finite state machine in go to poin function \mbox{\Hypertarget{namespacego__to__point_a36304a9f313b0579f7fc69fa01695524}\label{namespacego__to__point_a36304a9f313b0579f7fc69fa01695524}} 
...
\begin{DoxyParams}{Parameters}
{\em msg} & is the message of type Odometry to get robot position and quaternion\\
\hline
\end{DoxyParams}
Callback function of subscriber for topic /odom, get the position and the quaternion of the robot ~\newline
...
Function to match goal orientation. 


\begin{DoxyParams}{Parameters}
{\em des\+\_\+yaw} & is the desired angle\\
\hline
\end{DoxyParams}
Function to rotate the robot to have the goal orientation, when he is in the goal position \mbox{\Hypertarget{namespacego__to__point_a9c3011a3065fcbefcc1c5ad8c9979669}\label{namespacego__to__point_a9c3011a3065fcbefcc1c5ad8c9979669}} 
...
\begin{DoxyParams}{Parameters}
{\em des\+\_\+pos} & is the goal position to set the right angular velocity for rotation\\
\hline
\end{DoxyParams}
Function to rotate the robot to be headed for the goal \mbox{\Hypertarget{namespacego__to__point_ac8579665c0fbf665f734476554fac37d}\label{namespacego__to__point_ac8579665c0fbf665f734476554fac37d}} 
...
\hline
\end{DoxyParams}
Function to go straight ahead to the goal \mbox{\Hypertarget{namespacego__to__point_ab92bd6db1ec323a4d795ed6cb40aebe1}\label{namespacego__to__point_ab92bd6db1ec323a4d795ed6cb40aebe1}} 
...
Main function with declaration of a publisher for /cmd\+\_\+vel topic, a subscriber for /odom topic, an action server for go to point service. 
...
Function normalize an angle. 


\begin{DoxyParams}{Parameters}
{\em angle} & to be normalized\\
\hline
\end{DoxyParams}
Function to change state for finite state machine in go to poin function \mbox{\Hypertarget{namespacego__to__point_ae5adf65cf67db55213cd0ddb439a34f7}\label{namespacego__to__point_ae5adf65cf67db55213cd0ddb439a34f7}} 
\index{go\_to\_point@{go\_to\_point}!set\_velocities@{set\_velocities}}
\index{set\_velocities@{set\_velocities}!go\_to\_point@{go\_to\_point}}
\doxysubsubsection{\texorpdfstring{set\_velocities()}{set\_velocities()}}
{\footnotesize\ttfamily def go\+\_\+to\+\_\+point.\+set\+\_\+velocities (\begin{DoxyParamCaption}\item[{}]{msg }\end{DoxyParamCaption})}
