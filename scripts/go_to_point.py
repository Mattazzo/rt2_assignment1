...
.. module:: go_to_point
	:platform: Unix
	:synopsis: Python module to reach a goal position
	
.. moduleauthor: Matteo Azzin matteoazzini1999@gmail.com
...
"""yaw precision of 20 degrees"""
yaw_precision_ = math.pi / 9	

"""yaw precision of 2 degrees"""	
...
def set_velocities(msg):
	"""
	Function set constants to assign velocities
	
	Args:
		msg: is the twist of /cmd_vel topic
	"""
	global kp_d, kp_a
