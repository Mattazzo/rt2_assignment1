...
\item {\bfseries{\mbox{\hyperlink{user__interface_8py}{user\+\_\+interface.\+py}}}}\+: R\+OS node to let user command the robot, it has a client for Command service and an action client for Random\+Position service. When user press 1 robot it makes a request to {\itshape \mbox{\hyperlink{state__machine_8cpp}{state\+\_\+machine.\+cpp}}} and robot start moving, otherwise, if he press 0, there is a request for C\+Ommand server to stop the {\itshape \mbox{\hyperlink{state__machine_8cpp}{state\+\_\+machine.\+cpp}}} node, but also an action request {\itshape cancell\+\_\+all\+\_\+goals()} to cancel the goal for the robot and stop it as soon as possible. ~\newline
