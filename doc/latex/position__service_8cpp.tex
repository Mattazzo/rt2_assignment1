...
Service function to get a random position between the bounds specified in the request


\begin{DoxyParams}{Parameters}
{\em -\/} & req\+: bounds for the interval to choose the random position
\begin{DoxyItemize}
\item res\+: random position 
\end{DoxyItemize}\\
\hline
\end{DoxyParams}
...
Position server that return a random position between the bounds specified in the request Function to get a random number from the specified interval
...
\begin{DoxyItemize}
\item a random number between M and N 
\end{DoxyItemize}
\end{DoxyReturn}
